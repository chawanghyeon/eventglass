...
R3 remains open; R4 also remains open pending AWS restore, rollback, and release
evidence. The local Garage recovery contract passes but is not a production HA
