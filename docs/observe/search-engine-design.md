...
| 단일 Parquet + Parquet postings sidecar | 기본/동적 입력 각 1만·10만 레코드, 고정 DuckDB 2.0, ARM64 CPU1/512MiB에서 독립 건수·합 검증과 로컬 질의 30회씩 | 희소어 일부 개선, 흔한 단어 약 2배 지연·총 저장량 증가. 이 단순 결합은 기각 |
