...
| 색인+중복 제거 원문 페이지 | 실제 StageRecord 기본/무작위 토큰·속성값 각 10만 건을 전건 왕복 복원. 현행 두 Parquet 대비 합계 8.8%/20.2% 감소 | 이 입력의 저장량 개선. 단일 S3 객체 Range·상세 지연·전체 제품 타입은 미검증 |
