...
2026-09-12 사용자 요청에 따라 [비용 효율 제품 설계](cost-efficiency.md)의 C01–C06을 추가 구현 범위로 지정한다. C07 원격 형식 변경은 C05 측정으로 필요성이 입증될 때만 수행한다. 기존 P00–P12의 정확성·복구·자원 gate는 유지한다. 각 C 단계의 구현·검증 계약은 해당 문서 §7을 따른다.
