...
2026-09-12 비용 효율 중심 확장: [비용 효율 제품 설계](cost-efficiency.md)의 C01–C07을 추가 목표로 따른다. 수집 정책·사용량·검색 예산의 변경 계약은 해당 문서에 명시하며, 기존 내구성·권한·복구 계약은 유지한다. 목표 설계를 구현 완료로 해석하지 않는다.
