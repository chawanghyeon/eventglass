...
export function SystemPage() {
  ...
  const outcomes = useQuery({ queryKey: ["sdk-outcomes", session.user_id, tenant.tenant_id, startUS, endUS], queryFn: () => api.sdkOutcomes(tenant.tenant_id, startUS, endUS), enabled: tenant.role === "admin" });
  return <section>
