...
Compared SDK versions to shared tools/sdk-fixtures Python requirements.lock, Node/Browser package locks, and Go go.mod. Create independent Go fixtures/locks without changing these baselines. Existing Rust SDK success is not evidence of new Go server success. Rust captured fixtures now live under rust/tests/fixtures/.
